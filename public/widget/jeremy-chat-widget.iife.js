var JeremyChatWidget = (function(exports) {
...
`], ...formatTraceEntry(entry));
  ...
  function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
    ...
    if (isFunction(ref3)) {
      ...
      const _isString2 = isString(ref3);
      const _isRef = isRef(ref3);
      if (_isString2 || _isRef) {
        const doSet = () => {
          if (rawRef.f) {
            const existing = _isString2 ? canSetSetupRef(ref3) ? setupState[ref3] : refs[ref3] : ref3.value;
            if (isUnmount) {
  ...
  */
  var _config = {
    ...
    var labels = timeline.labels, min = _bigNum$1, p2, distance, label;
    for (p2 in labels) {
  ...
  */
  ...
  const _sfc_main = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
      ...
      const widgetStyles = computed(() => {
        ...
        return {
          "--bg-color": ((_a = props.theme) == null ? void 0 : _a.bgColor) || defaultBg,
          "--panel-bg-color": ((_b = props.theme) == null ? void 0 : _b.panelBgColor) || defaultPanelBg,
          "--white-color": ((_c = props.theme) == null ? void 0 : _c.textColor) || defaultText,
          "--text-field-stroke-color": ((_d = props.theme) == null ? void 0 : _d.borderColor) || defaultBorder
        };
      });
      ...
      const placeholderText = computed(() => {
        return isFocused.value || inputValue.value ? "You can use a suggested question (lame) or ask your own (cool)" : placeholderTexts[currentPlaceholderIndex.value];
      });
      ...
      const responseContainerRef = ref(null);
      const loadingRef = ref(null);
      const askAnotherRef = ref(null);
      ...
      const selectSuggestedQuery = (query) => {
      ...
      const animateLoadingOut = () => {
        if (loadingRef.value) {
          gsapWithCSS.to(loadingRef.value, {
            opacity: 0,
            y: -30,
            duration: 0.4,
            ease: "power2.in",
      ...
      const handleSubmit = () => __async(null, null, function* () {
        ...
        try {
          ...
          const response = yield fetch(props.apiUrl, {
            method: "POST",
            headers: {
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("main", _hoisted_2, [
              ...
              showLoading.value ? (openBlock(), createElementBlock("div", {
                ...
                _cache[4] || (_cache[4] = createStaticVNode('<svg class="loading-spinner" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" data-v-34b68a22><defs data-v-34b68a22><radialGradient id="fogGradient1" cx="30%" cy="30%" data-v-34b68a22><stop offset="0%" stop-color="rgba(255, 255, 255, 0.18)" data-v-34b68a22></stop><stop offset="30%" stop-color="rgba(255, 255, 255, 0.08)" data-v-34b68a22></stop><stop offset="60%" stop-color="rgba(255, 255, 255, 0.03)" data-v-34b68a22></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-34b68a22></stop></radialGradient><radialGradient id="fogGradient2" cx="70%" cy="60%" data-v-34b68a22><stop offset="0%" stop-color="rgba(252, 243, 234, 0.15)" data-v-34b68a22></stop><stop offset="40%" stop-color="rgba(252, 243, 234, 0.06)" data-v-34b68a22></stop><stop offset="70%" stop-color="rgba(252, 243, 234, 0.02)" data-v-34b68a22></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-34b68a22></stop></radialGradient><radialGradient id="fogGradient3" cx="50%" cy="80%" data-v-34b68a22><stop offset="0%" stop-color="rgba(255, 255, 255, 0.12)" data-v-34b68a22></stop><stop offset="40%" stop-color="rgba(255, 255, 255, 0.05)" data-v-34b68a22></stop><stop offset="70%" stop-color="rgba(255, 255, 255, 0.01)" data-v-34b68a22></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-34b68a22></stop></radialGradient><radialGradient id="centerGlow" data-v-34b68a22><stop offset="0%" stop-color="rgba(255, 255, 255, 0.15)" data-v-34b68a22></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.05)" data-v-34b68a22></stop><stop offset="80%" stop-color="rgba(255, 255, 255, 0.01)" data-v-34b68a22></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-34b68a22></stop></radialGradient><filter id="glow" data-v-34b68a22><feGaussianBlur stdDeviation="4" result="coloredBlur" data-v-34b68a22></feGaussianBlur><feMerge data-v-34b68a22><feMergeNode in="coloredBlur" data-v-34b68a22></feMergeNode><feMergeNode in="SourceGraphic" data-v-34b68a22></feMergeNode></feMerge></filter><filter id="softBlur" data-v-34b68a22><feGaussianBlur stdDeviation="3" data-v-34b68a22></feGaussianBlur></filter></defs><circle cx="60" cy="60" r="55" fill="url(#fogGradient1)" class="fog-layer-1" filter="url(#softBlur)" data-v-34b68a22></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient2)" class="fog-layer-2" filter="url(#softBlur)" data-v-34b68a22></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient3)" class="fog-layer-3" filter="url(#softBlur)" data-v-34b68a22></circle><circle cx="60" cy="60" r="40" fill="url(#centerGlow)" class="center-glow" filter="url(#glow)" data-v-34b68a22></circle></svg>', 1)),
  ...
  const JeremyChatWidget2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-34b68a22"]]);
  ...
  function initJeremyChatWidget(containerId, options = {}) {
    ...
    const app = createApp(JeremyChatWidget2, {
      apiUrl,
      theme: options.theme
    });
    app.mount(container);
  ...
  if (typeof window !== "undefined") {
    document.addEventListener("DOMContentLoaded", () => {
      ...
      widgets.forEach((el) => {
        ...
        const apiUrl = el.getAttribute("data-api-url") || void 0;
        const cssUrl = el.getAttribute("data-css-url") || void 0;
  ...
  if (typeof window !== "undefined") {
    window.JeremyChatWidget = {
      init: initJeremyChatWidget
    };
  }
  exports.initJeremyChatWidget = initJeremyChatWidget;
  Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
  return exports;
})({});
//# sourceMappingURL=jeremy-chat-widget.iife.js.map
