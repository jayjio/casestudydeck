...
`], ...formatTraceEntry(entry));
  ...
  */
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("main", _hoisted_2, [
              ...
              showLoading.value ? (openBlock(), createElementBlock("div", {
                ...
                _cache[4] || (_cache[4] = createStaticVNode('<svg class="loading-spinner" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" data-v-db4a9a37><defs data-v-db4a9a37><linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="100%" data-v-db4a9a37><stop offset="0%" stop-color="#f4d4c0" stop-opacity="0.6" data-v-db4a9a37></stop><stop offset="100%" stop-color="#e6b399" stop-opacity="0.3" data-v-db4a9a37></stop></linearGradient><linearGradient id="gradient2" x1="100%" y1="0%" x2="0%" y2="100%" data-v-db4a9a37><stop offset="0%" stop-color="#e6b399" stop-opacity="0.5" data-v-db4a9a37></stop><stop offset="100%" stop-color="#f4d4c0" stop-opacity="0.2" data-v-db4a9a37></stop></linearGradient><radialGradient id="centerGlow" cx="50%" cy="50%" data-v-db4a9a37><stop offset="0%" stop-color="#f4d4c0" stop-opacity="0.8" data-v-db4a9a37></stop><stop offset="50%" stop-color="#e6b399" stop-opacity="0.4" data-v-db4a9a37></stop><stop offset="100%" stop-color="#e6b399" stop-opacity="0" data-v-db4a9a37></stop></radialGradient><filter id="glow" data-v-db4a9a37><feGaussianBlur stdDeviation="3" result="coloredBlur" data-v-db4a9a37></feGaussianBlur><feMerge data-v-db4a9a37><feMergeNode in="coloredBlur" data-v-db4a9a37></feMergeNode><feMergeNode in="SourceGraphic" data-v-db4a9a37></feMergeNode></feMerge></filter></defs><ellipse cx="60" cy="60" rx="50" ry="35" fill="url(#gradient1)" class="fog-layer-1" data-v-db4a9a37></ellipse><ellipse cx="60" cy="60" rx="45" ry="40" fill="url(#gradient2)" class="fog-layer-2" data-v-db4a9a37></ellipse><circle cx="60" cy="60" r="35" fill="url(#centerGlow)" class="center-glow" filter="url(#glow)" data-v-db4a9a37></circle></svg>', 1)),
  ...
  const JeremyChatWidget2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-db4a9a37"]]);
