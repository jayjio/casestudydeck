...
`], ...formatTraceEntry(entry));
  ...
  */
          ...
          createBaseVNode("div", _hoisted_1, [
            createBaseVNode("main", _hoisted_2, [
              ...
              showLoading.value ? (openBlock(), createElementBlock("div", {
                ...
                _cache[4] || (_cache[4] = createStaticVNode('<svg class="loading-spinner" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" data-v-0e36195a><defs data-v-0e36195a><radialGradient id="fogGradient1" cx="30%" cy="30%" data-v-0e36195a><stop offset="0%" stop-color="rgba(255, 255, 255, 0.15)" data-v-0e36195a></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.05)" data-v-0e36195a></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-0e36195a></stop></radialGradient><radialGradient id="fogGradient2" cx="70%" cy="60%" data-v-0e36195a><stop offset="0%" stop-color="rgba(252, 243, 234, 0.12)" data-v-0e36195a></stop><stop offset="60%" stop-color="rgba(252, 243, 234, 0.03)" data-v-0e36195a></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-0e36195a></stop></radialGradient><radialGradient id="fogGradient3" cx="50%" cy="80%" data-v-0e36195a><stop offset="0%" stop-color="rgba(255, 255, 255, 0.1)" data-v-0e36195a></stop><stop offset="50%" stop-color="rgba(255, 255, 255, 0.02)" data-v-0e36195a></stop><stop offset="100%" stop-color="rgba(255, 255, 255, 0)" data-v-0e36195a></stop></radialGradient><radialGradient id="centerGlow" data-v-0e36195a><stop offset="0%" stop-color="rgba(255, 255, 255, 0.12)" data-v-0e36195a></stop><stop offset="70%" stop-color="rgba(255, 255, 255, 0)" data-v-0e36195a></stop></radialGradient><filter id="glow" data-v-0e36195a><feGaussianBlur stdDeviation="2" result="coloredBlur" data-v-0e36195a></feGaussianBlur><feMerge data-v-0e36195a><feMergeNode in="coloredBlur" data-v-0e36195a></feMergeNode><feMergeNode in="SourceGraphic" data-v-0e36195a></feMergeNode></feMerge></filter></defs><circle cx="60" cy="60" r="55" fill="url(#fogGradient1)" class="fog-layer-1" data-v-0e36195a></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient2)" class="fog-layer-2" data-v-0e36195a></circle><circle cx="60" cy="60" r="55" fill="url(#fogGradient3)" class="fog-layer-3" data-v-0e36195a></circle><circle cx="60" cy="60" r="40" fill="url(#centerGlow)" class="center-glow" filter="url(#glow)" data-v-0e36195a></circle></svg>', 1)),
  ...
  const JeremyChatWidget2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0e36195a"]]);
